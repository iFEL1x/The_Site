# <p align="center"> The Site (study)</p>

## Описание проекта

Данный проект является изучением инструмента Scroll View.

Проект собран в Unity3D, с использованием только инструментов движка.
...
**Основная задача проекта** - Изучение возможностей инструмента Scroll View в Unity3D.
